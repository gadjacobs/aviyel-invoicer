...
export default function SideBar({ invoices, customers, getCurrentInvoice, currentInvoice }) {
  ...
  return (
    <aside className="relative sidebar-bg h-screen max-h-screen w-96 hidden sm:block shadow-xl">
      ...
      <nav className="text-white text-base font-semibold h-3/4 overflow-y-auto pb-2">
